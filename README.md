...
- [Agent Skill Organization](documentation/development-workflow/AGENT-SKILLS.md) explains how agents discover the project skills under `${LIXPI_REPOSITORY_PATH}/skills/` and how to add optional harness links.
