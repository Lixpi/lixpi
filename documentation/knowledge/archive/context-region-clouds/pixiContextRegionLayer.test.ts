...
describe('pixiContextRegionLayer — selected chrome regression guards', () => {
    ...
    it('renders active context-region feedback only on the thought circle', () => {
        ...
        expect(source).toContain("import { Easing } from '@lixpi/canvas-engine/frontend/animation'")
        expect(source).toContain("import { FreeformGradientRenderer } from '@lixpi/canvas-engine/frontend/rendering'")
