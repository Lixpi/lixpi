...
| `.scss` files, styles inside Svelte components, or code that creates or selects styled DOM elements | [`SASS-AND-CSS.md`](SASS-AND-CSS.md) |
| `services/web-ui` UI work — Svelte components, D3/SVG, canvas chrome, ProseMirror plugins, shared components | [`UI-COMPONENTS.md`](UI-COMPONENTS.md), in addition to the guides above |
...
Guides stack: a Svelte component with styles and TypeScript logic requires all three.
