...
description: 'Create or revise Mermaid diagrams in Lixpi documentation. Use for flowcharts, sequence diagrams, state diagrams, Mermaid themes, diagram palettes, phase blocks, or diagram accessibility.'
---

# Mermaid Diagrams

Use these rules to create consistent, readable Mermaid diagrams in documentation. All diagrams should use the **"In the Sunshine"** pastel palette for visual consistency across the codebase.
