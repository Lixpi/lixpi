...
export const createInfrastructure = async () => {
    ...
    createModelPricingService({
        ...
        environment: {
            ...
            MODEL_PRICING_RECONCILIATION_INTERVAL_MS: '21600000',
            MODEL_PRICING_RECONCILIATION_SETTLEMENT_LAG_DAYS: '14',
            ...
            AI_MODELS_LIST_TABLE_NAME: dynamoDBtables.aiModelsListTable.name,
