...
The native storage acceptance test exercises API Blob writes, event sequencing, replay and workqueue acknowledgements against a disposable NATS broker. Commands and isolation requirements are in the [TypeScript testing guide](../../documentation/testing/TypeScript/TESTING-GUIDE.md).
