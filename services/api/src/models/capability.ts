...
export const serializeCapabilityManifest = (manifest: CapabilityManifest): Uint8Array => textEncoder.encode(
    JSON.stringify(
...
const encodeCursor = (cursor: CapabilityCatalogCursor): string => Buffer.from(
