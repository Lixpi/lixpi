...
import type { AxisExtraction, SceneAssessment } from '@lixpi/constants'

import { callStructuredVlm, type VlmJsonSchema } from '../vlm-client.ts'
import type { ChatMessage } from '../../graph/state.ts'
import type { ExtractionState, FeatureExtractor, StageLogger } from '../types.ts'
...
export const buildExtractorMessages = (state: ExtractionState, scene: SceneAssessment): ChatMessage[] => {
