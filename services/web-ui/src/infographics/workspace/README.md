...
Session history control sizing, prominent action hover colors, row hover gradient, and thread marker colors are configured through `settings.aiChatThread.sessionHistory`.
