...
This module renders the main workspace view: a zoomable, pannable canvas where Asset-backed documents, images, videos, and branch lineage markers appear as draggable, resizable canvas nodes. The only AI prompt input is the screen-fixed composer at the bottom-center of the canvas; the right-side panel browses Capabilities and Assets and reopens conversation Assets. Conversations do not persist as canvas nodes.
