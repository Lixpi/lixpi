...
- Ready media renders its Asset title persistently at the top of the node. The final descriptor VLM pass supplies a two-to-three-word title alongside the summary and tags; expanded media details place the description and tags before Asset diagnostics and provenance.
