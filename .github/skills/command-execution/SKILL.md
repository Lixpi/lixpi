...
description: 'Hard Lixpi command policy for shell commands, package managers, dependency installs, project setup, scripts, builds, docs builds, linting, formatting, tests, and Node tooling. Never run npm, npx, pnpm, or pnpx on the host; use Docker containers.'
---
