...
export function drawDocumentContentBlock(parent: any, config: ContentBlockConfig) {
    if (config.variant === 'top') {
        ...
        applyStroke(parent.append('line').attr('x1', 163).attr('y1', 94.5).attr('x2', 399).attr('y2', 94.5)) // Top line dots
        ...
        applyStroke(parent.append('line').attr('x1', 89).attr('y1', 417.5).attr('x2', 248.502).attr('y2', 417.5)) // Bottom three squares
