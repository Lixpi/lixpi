...
Document-scoped DOM templates come from `createDocumentHtml` in [UI Primitives](../ui-primitives/README.md). Capability-specific views remain inside their Capability modules.
