export class Easing {
    ...
    static cubicBezierAtTime(
        ...
        return sampleCurveY(
            Easing.clampProgress(progress),
        )
    }

    // Canvas and PIXI animations cannot consume Sass transition variables directly.
    // This mirrors hoverTransition from @lixpi/ui-primitives/styles/transitions.
    static hoverTransition(progress: number): number {
        return Easing.cubicBezierAtTime(
            0.19,
            1,
            0.22,
            1,
