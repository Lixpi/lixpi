...
export const computeWorldPosition = <Node extends CanvasPositionedNode>(
    node: Node,
...
export const buildNodesById = <Node extends CanvasPositionedNode>(nodes: readonly Node[]): Map<string, Node> => {
    return new Map(
