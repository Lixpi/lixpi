...
This page describes the upstream primitive. The engine's public controller owns its own gesture/resize lifecycle and does not promise the entire wrapper feature set.
