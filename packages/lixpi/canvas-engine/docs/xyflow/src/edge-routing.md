...
Engine connector helpers extend the upstream path families. ConnectorRenderer paints neutral resource paths; it does not require SVG data joins in the application. See [engine connectors](../../EDGES-AND-CONNECTIONS.md).
