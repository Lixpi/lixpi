...
// collision geometry.
export const normalizeBranchLineageNodeGap = (gap: number): number => (Number.isFinite(gap) ? Math.max(0, gap) : 0)
...
export const applyBranchLineageNodeGap = (
