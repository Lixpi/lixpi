    ...
    return html`
        ...
        >
                ...
                <section>
                    <h3>Best results</h3>
                    <ul>
                        ${sheet.bestResults.map(item => html`<li>${item}</li>`)}
                    </ul>
                </section>
                <section>
                    <h3>Limitations</h3>
                    <ul>
                        ${sheet.limitations.map(item => html`<li>${item}</li>`)}
                    </ul>
                </section>
                <section>
                    <h3>Execution</h3>
                    <p>${sheet.executionCharacteristics.summary}</p>
                    <p className="capability-description-execution">
                        Cost: ${sheet.executionCharacteristics.cost}. Latency: ${sheet.executionCharacteristics.latency}.
                    </p>
                </section>
            </article>
    ` as HTMLElement
