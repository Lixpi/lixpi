...
type GenerationRequestCoordinate = {
...
export type WorkspaceCanvasGenerationPorts = {
    ...
    resolveReference: (request: GenerationRequestCoordinate & {
        bindingId: string
        assetId: string
    }) => Promise<unknown>
    startVerification: (request: GenerationRequestCoordinate & {
...
export type WorkspaceCanvasHost = {
    ...
    capabilities: {
        ...
        catalog: (
            workspaceId: string,
            organizationId: string,
        ) => Pick<CapabilityCatalogClient, 'list' | 'get' | 'invalidate'>
        promptCatalog: (
            workspaceId: string,
            organizationId: string,
    ...
    }) => WorkspaceGenerationHistoryPorts['progressDetails']
