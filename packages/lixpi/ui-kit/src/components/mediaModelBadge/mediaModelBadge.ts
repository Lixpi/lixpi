    ...
    return html`
        ...
        >
            ${icon ? html`<span
                ...
                ></span>` : null}
                ${visibleLabel ? html`
                    <span className="media-model-badge-name"
                          >${providerTitle ? html`<span className="media-model-badge-provider">${providerTitle}</span>` : null}${separator}${modelTitle ? html`<span className="media-model-badge-model">${modelTitle}</span>` : null}</span
                      >
                ` : null}
            </div>
    ` as HTMLElement
