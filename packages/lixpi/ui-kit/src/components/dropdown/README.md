...
- Hover + selected states use a simple two-color CSS gradient based on the shifting gradient palette; its relationship to the animated gradient system is documented in [Visual Effects](../../../../ui-primitives/docs/GRADIENTS.md)
